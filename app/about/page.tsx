    ...
    <main className="flex justify-center items-center content-center flex-col">
      <section className="flex justify-center items-center flex-col max-w-6xl px-4">
        ...
        <p className="mb-5">
          ...
          place. Here, we track and showcase how well Plat Chat members
          prediction outcomes of major international tournaments. It's all about
          adding more fun to the esports experience! Quick heads-up: I don't
          have loads of individual data for the Plat Chat crew, so sorry Avast
          for the rough success rate showcase. Most of my info is on the group
          as a whole, Sliggy, and Thinking Man Valorant – that's why their
          predictions seem more spot-on. The rest of you, I need you to do more
        ...
        <section>
          ...
          <p className="mb-5">
            ...
            total matches predicted, and the number of correct guesses. Keeping
            it simple for you and me – that's the idea! For more info, checkout
            my spreadsheet and sources down below:
        ...
        <section>
          ...
          <p className="mb-5">
            ...
            actual match results. I used smiling faces to show a success rate
            above or equal to 50%, while sad faces are used for rates below 50%.
            Think of it as fun with a dash of serious. And yep, I'm aware there
            are gaps – like group or playoff series prediction data. But hey,
            maybe you guys or the Plat Chat members can help fill in those
            blanks someday!
          </p>
        </section>
        <section>
          ...
          <p className="mb-5">
            ...
            skipping a lot of the regional predictions and missing many of the
            playoff series data. For the sake of fun and simplicity, I've
            treated all matches equally, even if predicitions migh skew a bit as
            the tournament goes deeper. Got more data or spotted something off?
            Holler at me at
